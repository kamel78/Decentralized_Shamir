...
impl EicCrypt {
    ...
    #[wasm_bindgen(js_name = "encrypt_pdf_bytes")]
    pub fn encrypt_pdf_bytes(&self, public_key: String, pdf_data: &[u8]) -> Vec<u8> {
        self.core.encrypt_pdf_bytes_2(public_key, pdf_data)
    }

    #[wasm_bindgen]
    pub fn decrypt_pdf_bytes(&self, secret_key: String, encrypted_data: &[u8]) -> Vec<u8> {
        self.core.decrypt_pdf_bytes_2(secret_key, encrypted_data)
    }
}
